...
namespace NinMods.Hooking.LowLevel.hde
{
    public class table64
    {
        ...
        public const uint DELTA_OPCODES = 0x4a;
        public const uint DELTA_FPU_REG = 0xfd;
        public const uint DELTA_FPU_MODRM = 0x104;
        public const uint DELTA_PREFIXES = 0x13c;
        public const uint DELTA_OP_LOCK_OK = 0x1ae;
        public const uint DELTA_OP2_LOCK_OK = 0x1c6;
        public const uint DELTA_OP_ONLY_MEM = 0x1d8;
        public const uint DELTA_OP2_ONLY_MEM = 0x1e7;

        public byte[] hde64_table = new byte[] {
